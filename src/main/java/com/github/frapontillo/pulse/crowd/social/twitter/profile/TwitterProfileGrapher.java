...
public class TwitterProfileGrapher extends IProfileGrapher {
    ...
    private static final Logger logger = PulseLogger.getLogger(TwitterProfileGrapher.class);
        ...
        try {
            ...
            do {
                try {
                    ...
                    friends = twitter.getFriendsList(profile.getUsername(), actualCursor,
                            MAX_FRIENDS_PER_REQUEST, true, false);
